...
describe('Validating users', () => {
  ...
  test('users are saved to valid users output binding when they contain additional properties', () => {
    const userAdditionalProp = { ...validInput, additionalProperty: 'additionalProperty' }
    const users = [userAdditionalProp]
